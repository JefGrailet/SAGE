 ...
 * -October 2019: slight changes in order to return ProbeRecord objects by value rather than via 
 *  pointers. A VOID_RECORD object is used to denote absent records.
 */
...
public:
    ...
    static ProbeRecord VOID_RECORD;
